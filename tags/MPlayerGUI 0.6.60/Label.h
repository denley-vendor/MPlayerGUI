...
public:
  ...
  virtual CLabel& SetTextEllipsis(BOOL bEllipsis); // Added by Jason to display ellipsis
...
protected:
	...
	CString			m_sLink;
  BOOL        m_bTextEllipsis; // Added by Jason to display ellipsis at end of text
