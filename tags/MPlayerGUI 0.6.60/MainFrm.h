...
private:
  ...
  typedef struct
  {
    ...
    BOOL bDisableMPlayerMonitor;   // disable MPlayerMonitor Thread?
    BOOL bEnableLogging;           // Enable/Disable Logging System?
...
protected:
  ...
  afx_msg OnSliderProgress(WPARAM wParam, LPARAM lParam);
  afx_msg OnSliderVolume(WPARAM wParam, LPARAM lParam);
  afx_msg OnPlayListPlay(WPARAM wParam, LPARAM lParam);
  afx_msg void OnDropFiles(HDROP hDropInfo);
  afx_msg OnPlaylistDlgHide(WPARAM wParam, LPARAM lParam);
  afx_msg OnLogDlgHide(WPARAM wParam, LPARAM lParam);
  afx_msg OnStartupOpenfile(WPARAM wParam, LPARAM lParam);
  afx_msg OnViewMPlayerPause(WPARAM wParam, LPARAM lParam);
  afx_msg OnViewMPlayerFullScreen(WPARAM wParam, LPARAM lParam);
  ...
  afx_msg OnMPlayerStarting(WPARAM wParam, LPARAM lParam);
  afx_msg OnMPlayerStartPlaying(WPARAM wParam, LPARAM lParam);
	afx_msg OnMPlayerFailedToStart(WPARAM wParam, LPARAM lParam);
	afx_msg OnMPlayerAutoStopped(WPARAM wParam, LPARAM lParam);
  afx_msg OnMPlayerStopped(WPARAM wParam, LPARAM lParam);
	afx_msg OnMPlayerUpdateProgress(WPARAM wParam, LPARAM lParam);
	afx_msg OnMPlayerUpdateCacheFill(WPARAM wParam, LPARAM lParam);
  afx_msg OnMPlayerLog(WPARAM wParam, LPARAM lParam);
